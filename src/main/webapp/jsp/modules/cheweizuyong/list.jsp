...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">车位租用管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>车位租用列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">车位租用列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('zuyongbianhao')">租用编号<i id="zuyongbianhaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('jinchangshijian')">进场时间<i id="jinchangshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var zuyongbianhaoCell  = document.createElement('td');

						 zuyongbianhaoCell.innerHTML = item.zuyongbianhao;


			row.appendChild(zuyongbianhaoCell);
			...
			var jinchangshijianCell  = document.createElement('td');

						  jinchangshijianCell.innerHTML = item.jinchangshijian;


			row.appendChild(jinchangshijianCell);
		...
		function sh(){
			...
			httpJson("cheweizuyong/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("cheweizuyong/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"cheweizuyong");
