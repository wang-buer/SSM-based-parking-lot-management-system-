...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('tingfangshizhang')">停放时长<i id="tingfangshizhangIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('zuyongjine')">租用金额<i id="zuyongjineIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var tingfangshizhangCell  = document.createElement('td');

						 tingfangshizhangCell.innerHTML = item.tingfangshizhang;


			row.appendChild(tingfangshizhangCell);
			var zuyongjineCell  = document.createElement('td');

						 zuyongjineCell.innerHTML = item.zuyongjine;


			row.appendChild(zuyongjineCell);
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"cheweituizu");
