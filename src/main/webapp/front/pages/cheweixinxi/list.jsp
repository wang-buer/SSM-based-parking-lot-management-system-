  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#cheweiquyu').val()) {
          param['cheweiquyu'] = jquery('#cheweiquyu').val() ? '%' + jquery('#cheweiquyu').val() + '%' : '';
        }  
        if (jquery('#cheweihao').val()) {
          param['cheweihao'] = jquery('#cheweihao').val() ? '%' + jquery('#cheweihao').val() + '%' : '';
        }  
        if (jquery('#cheweiweizhi').val()) {
          param['cheweiweizhi'] = jquery('#cheweiweizhi').val() ? '%' + jquery('#cheweiweizhi').val() + '%' : '';
        }  
