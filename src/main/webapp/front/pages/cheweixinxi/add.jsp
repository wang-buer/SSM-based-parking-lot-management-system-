			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="cheweiquyu" id="cheweiquyu" lay-filter="cheweiquyu">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in cheweiquyu" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
                        ...
                        <div class="layui-input-block">
                            <select name="cheweiweizhi" id="cheweiweizhi" lay-filter="cheweiweizhi">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in cheweiweizhi" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                								...
                								vue.cheweiquyu = 'A区,B区,C区,D区,E区'.split(',')
																								// 上传图片
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																...
																vue.cheweiweizhi = 'B1,B2'.split(',')
																vue.cheweizhuangtai = '空闲,已租'.split(',')
																								laydate.render({
					elem: '#clicktime',
					type: 'datetime'
				});
