				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>停放时价：</span>
							<span class="desc">
								{{detail.tingfangshijia}}
							</span>
						</div>
																								<div class="detail-item">
							<span>进场时间：</span>
							<span class="desc">
								{{detail.jinchangshijian}}
							</span>
						</div>
																								<div class="detail-item">
							<span>备注：</span>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('cheweizuyong','退租')" @click="onAcrossTap('cheweituizu')" type="button" class="layui-btn">
								退租
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`cheweizuyong`);
